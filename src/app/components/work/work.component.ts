...
@Component({
  selector: 'app-work', standalone: true, imports: [CommonModule, HttpClientModule, NgIf, NgbDropdownModule], templateUrl: './work.component.html', styleUrl: './work.component.scss'
})
